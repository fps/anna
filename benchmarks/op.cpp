...
template<int Channels>
static inline void run_conv1d_bias_tanh20_2(benchmark::State & state)
{
  conv1d_bias_tanh2<float, Channels, Channels, 3, (1 << 0), 64,
  conv1d_bias_tanh2<float, Channels, Channels, 3, (1 << 1), 64,
  conv1d_bias_tanh2<float, Channels, Channels, 3, (1 << 2), 64,
  conv1d_bias_tanh2<float, Channels, Channels, 3, (1 << 3), 64,
  conv1d_bias_tanh2<float, Channels, Channels, 3, (1 << 4), 64,
  conv1d_bias_tanh2<float, Channels, Channels, 3, (1 << 5), 64,
  conv1d_bias_tanh2<float, Channels, Channels, 3, (1 << 6), 64,
  conv1d_bias_tanh2<float, Channels, Channels, 3, (1 << 7), 64,
  conv1d_bias_tanh2<float, Channels, Channels, 3, (1 << 8), 64,
  conv1d_bias_tanh2<float, Channels, Channels, 3, (1 << 9), 64,
  conv1d_bias_tanh2<float, Channels, Channels, 3, (1 << 0), 64,
  conv1d_bias_tanh2<float, Channels, Channels, 3, (1 << 1), 64,
  conv1d_bias_tanh2<float, Channels, Channels, 3, (1 << 2), 64,
  conv1d_bias_tanh2<float, Channels, Channels, 3, (1 << 3), 64,
...
BENCHMARK(run_conv1d_bias_tanh20_2<(channels)16>);
